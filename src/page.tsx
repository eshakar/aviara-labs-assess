...
//https://api.openweathermap.org/data/2.5/forecast?q=pune&appid=eb7c115444d562a781b1aca5623975e0&cnt=56
  ...
  const { isLoading, error, data, refetch } = useQuery<WeatherResponse>({
    ...
    queryFn: async () => {
      const { data } = await axios.get(
        ...
        {
          params: {
            q: "pune", // or any city you want to query
            appid: "eb7c115444d562a781b1aca5623975e0",
            cnt: 56,
          },
        }
      );
